...
<body>
  ...
  <div class="header_section">
        ...
        <div class="col-md-9">
          <div class="menu_text">
            <ul>
              <div class="togle_3">
                <div class="menu_main">
                  <div class="padding_left0"><a href="{{url('register')}}">Register</a>
    ...
    <div class="banner_section layout_padding">
      <div class="container">
        <div class="row">
          <div class="col-sm-7">
            <h1 class="banner_taital">ekstrakulikuler</h1>
            <h1 class="banner_taital_1">sman 3 ketapang</h1>
            <p class="banner_text">Yuk Bergabung Untuk Berpatisipasi bersama ekstrakulikuler SMA N 3 Ketapang</p>
 ...
 {{--  <div class="services_section layout_padding">
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          <h1 class="services_taital"><span>Tentang </span>  <span
              style="color: #1f1f1f">Ekstrakulikuler</span></h1>
  ...
  <div class="team_section layout_padding">
    <div class="container">
      <h1 class="choose_taital"><span>Ekstra Kulikuler </span> <span style="color: #1f1f1f">SMA Negeri 3</span>
      </h1>
      <p class="choose_text">Yuk Cari Tahu Lebih Lanjut Tentang Ekstra Kulikuler di SMA 3
        aliqua</p>
        ...
        <div class="container">
          ...
          @foreach($list_extra as $extra)
            ...
            <div class="images_main_1">
              <div class="row">
                <div class="col-sm-5">
                  <div class="image_4"><img src="{{url('public')}}/pngegg.png" style="height: 100;"></div>
  ...
  <div class="copyright_section">
    <div class="container">
      <p class="copyright_text">Developer 2023 By Feny </p>
    </div>
  </div>
