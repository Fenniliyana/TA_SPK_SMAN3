...
<div class="card">
  <div class="card-body">
                    ...
                    <form action="{{url('potensi/next1')}}" method="post">
                     ...
                     <div class="mb-3">
                           <label for="formFile" class="form-label">Apakah Anda Mempunyai <strong>{{$kriteria->kriteria_nama}}</strong> pada ekstrakurikuler <strong>{{$ekskul->nama}}</strong> ?</label>
                    ...
                    <nav aria-label="...">
                      <ul class="pagination">
                        ...
                        <li class="page-item " aria-current="page"><a class="page-link" href="javascript:;">2 
...
<script>
     Swal.fire({
     title: 'Informasi',
     text: 'Untuk Mengisi Pertanyaan Perhatikan Dengan Baik Minat Anda Pada Ekstrakulikuler, Karena Pengisian Pertanyaan Hanya di Lakukan 1 kali',
     icon: 'info',
