                ...
                <div class="row g-0">
                  ...
                  <div class="col-lg-6">
                    <div class="card-body p-4 p-sm-5">
                      <h5 class="card-title">Lupas Password?</h5>
                      <p class="card-text mb-5">Masukkan Email Yang Kamu Daftarkan</p>
                      <form class="form-body" method="POST" action="{{url('lupaPassword/cek')}}">
                        @csrf
                          <div class="row g-3">
                            <div class="col-12">
                              <label for="inputEmailid" class="form-label">Email</label>
                              <input type="email" name="email" class="form-control form-control-lg radius-30" id="inputEmailid" placeholder="Email kamu">
                            </div>
                            <div class="col-12">
