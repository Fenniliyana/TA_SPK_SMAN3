<meta charset="utf-8">
  ...
  <link rel="icon" href="{{url('public')}}/logo.png" type="image/png" />
  <!--plugins-->
  ...
  <!--Theme Styles-->
  {{-- <link href="{{url('public')}}/assets/css/dark-theme.css" rel="stylesheet" /> --}}
  {{-- <link href="{{url('public')}}/assets/css/light-theme.css" rel="stylesheet" /> --}}
  <link href="{{url('public')}}/assets/css/semi-dark.css" rel="stylesheet" />
<!--   <link href="{{url('public')}}/assets/css/blue.css" rel="stylesheet" /> -->
  <link href="{{url('public')}}/assets/css/header-colors.css" rel="stylesheet" />

  <title>SPK SMAN 3</title>
